...
class RouteTest extends TestCase
{
     ...
     */
    protected function makeRequest($path, $method = 'GET', $host = 'tempvsd.andsmind.com')
    {
    ...
    {
        $this->route->redirect('foo', 'http://tempvsd.andsmind.com', 302);
        ...
        $this->assertEquals('http://tempvsd.andsmind.com', $response->getData());
    }
