...
function headAdbgcolor() {
    ...
    else if(a.indexOf("/jieshaoadmin") != -1){
        $(".bodybox .header .jieshaoadmin").css({
            color: "#fff",
            background: "#ED2842"
        })

    }
    else if(a.indexOf("/dongshi") != -1){
        $(".bodybox .header .dongshi").css({
            color: "#fff",
            background: "#ED2842"
        })

    }
    else if(a.indexOf("/jiangjin") != -1){
        $(".bodybox .header .jiangjin").css({
            color: "#fff",
            background: "#ED2842"
        })

    }
    else if(a.indexOf("/riqi") != -1){
        $(".bodybox .header .riqi").css({
            color: "#fff",
            background: "#ED2842"
        })
    ...
    else if(a.indexOf("/tiangandizhi") != -1){
        $(".bodybox .header .tiangandizhi").css({
            color: "#fff",
            background: "#ED2842"
        })
